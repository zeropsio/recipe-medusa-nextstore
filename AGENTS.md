...
- SDK: [`src/lib/config.ts`](src/lib/config.ts) accepts `NEXT_PUBLIC_MEDUSA_BACKEND_URL` or `MEDUSA_BACKEND_URL`. Region proxy ([`src/proxy.ts`](src/proxy.ts)) needs a reachable Medusa + publishable key at runtime.
